...
ActiveRecord::Schema.define(version: 2022_05_30_045900) do
  ...
  create_table "posts_tags", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb3", force: :cascade do |t|
